...
It was essential to conduct a pilot in order to make sure that the software does not misbehave. In addition, the pilot brought light into how people who have never been exposed to the graphs before react on them. There were 3 participants in the pilot. All of them said that the training in the beginning of the experiment is sufficient at explaining how to read the graphs. One of the participants, however, wanted to confirm with the experimenter that the correct direction of reading the graphs is from left to top. This is why the first 4 sessions in the beginning of the experiment are trials during which the participants can ask questions in order to understand how to read the graphs and their answers are not recorded. 

All participants in the pilot said that the tasks are clear, graphs font size is readable, and different layouts and sizes are appropriately displaying the data. One participant mentioned that in the orthogonal layout in one of the node-link graphs, the label is on the arrow which makes it hard to read. The reason for this is that both labels and arrows are in black colour. Their note was taken into consideration and changes were made to make the label easy to read. One out of three participants said that they got bored during the experiment. The same participants complained that their eyes hurt at the 7th question and did not finish the experiment. 

Furthermore, some of the participants mentioned that it is hard to find the label you are looking for and they guessed the answer to the question by logical reasoning. To avoid this in the experiment, a note will be made to tell participants that there is no logical relationship between the causal relationships and they should not attempt to guess the correct answer. It was also noted, that when a particular node has more than one causal relationship, it is much harder to follow a path, than in a complex matrix-based graph with many relationships.

The pilot was very helpful at spotting technical issues. It was found that in one question the correct answer was being evaluated to incorrect because of a typo in the csv file that populated the database. Another technical issue found was the time recording. The timing was starting and stopping when required, but the moment where the time taken was recorded a wrong startTime variable was evaluated. This was a scope issue, which was fixed for the real experiment.  
